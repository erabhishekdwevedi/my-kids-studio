// Snake Game App - World-Class
import React, { useState, useRef } from 'react';
import { Box, Typography, Container, IconButton, Grid, Paper } from '@mui/material';
...
const SnakeGameApp: React.FC = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)' }}>
      <AppNavigation appName="Snake Game 🐍" score={score} gradient={GRADIENT} />
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Paper elevation={3} sx={{ p: 2, borderRadius: 4, overflow: 'hidden', position: 'relative', height: '60vh', maxHeight: '500px', mb: 3 }}>
          <Box sx={{ width: '100%', height: '100%', backgroundColor: '#1a1a2e', borderRadius: 2, position: 'relative', overflow: 'hidden' }}>
            <SnakeGame ref={gameRef} onScoreChange={handleScoreChange} themeColor="#38ef7d" />
          </Box>
